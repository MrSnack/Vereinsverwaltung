...
public class ComboBoxModels {
    ...
    public static DefaultComboBoxModel<String> getSchiedsrichter() {
        if (Verwaltung.getInstance().getSchiedsrichter()== null) {
            String[] fallback = new String[1];
            fallback[0] = "keine Mannschaften";
            return new javax.swing.DefaultComboBoxModel(fallback);
        } else {
            ...
            for (Schiedsrichter mann : schiedsrichter) {
                schiedsrichterBez[schiedsrichter.indexOf(mann)] = mann.getName();
            }
            return new javax.swing.DefaultComboBoxModel(schiedsrichterBez);
        }
    }
